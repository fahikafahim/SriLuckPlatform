...
@if(session('success'))
    <div
      id="success-popup"
      class="fixed top-5 right-5 bg-red-400 text-white px-4 py-2 rounded shadow-lg"
      style="z-index: 9999;"
    >
        {{ session('success') }}
    </div>
...
<script>
    // Cart functionality
    // In your product listing page (where addToCart is called)
function addToCart(product) {
    ...
    function updateCartCount() {
        ...
        // Update cart count in navbar (assuming you have an element with id 'cartCount')
