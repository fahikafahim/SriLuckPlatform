                ...
                <div class="max-w-6xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="md:flex">
                        ...
                        <div class="md:w-1/2 p-6">
                            ...
                            <!-- Price -->
                            <div class="mb-4">
                                <span class="text-2xl font-bold text-amber-700">Rs.{{ number_format($product->price, 2) }}</span>
                                @if($product->compare_at_price)
                                <span class="ml-2 text-gray-500 line-through">Rs.{{ number_format($product->compare_at_price, 2) }}</span>
                                @endif
                            </div>
                                ...
                                <div class="flex space-x-8">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex space-x-2">
                                            <span class="px-3 py-1 bg-gray-100 rounded-md">{{ $product->size }}</span>
                                        </div>
                                    </div>
                                    @endif
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex items-center">
                                    <button class="px-3 py-1 bg-gray-200 rounded-l-md hover:bg-gray-300" onclick="decrementQuantity()">
                                        <i class="fas fa-minus"></i>
                                    </button>
                                    <input type="number" id="quantity" value="1" min="1"
                                           class="w-16 text-center border-t border-b border-gray-200 py-1">
                                    <button class="px-3 py-1 bg-gray-200 rounded-r-md hover:bg-gray-300" onclick="incrementQuantity()">
