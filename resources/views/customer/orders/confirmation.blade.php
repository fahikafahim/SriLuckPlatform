                ...
                <div class="p-8">
                        ...
                        <div>
                            <div class="bg-gray-50 p-6 rounded-lg mb-6">
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900">{{ $order->address }}, {{ $order->city }},
                            ...
                            <div class="bg-blue-50 p-6 rounded-lg">
                                ...
                                @if ($order->payment_status === 'paid')
                                    <p class="text-gray-700 mb-4">Your payment has been successfully processed. We're
                                        preparing your order for shipment.</p>
                                    <p class="text-gray-700">You'll receive a confirmation email with tracking
                                        information once your order ships.</p>
                                @else
                                    <p class="text-gray-700 mb-4">Your order has been received and will be processed
                                        shortly.</p>
                                    <p class="text-gray-700">Please prepare the exact amount
                                        (Rs.{{ number_format($order->total_amount, 2) }}) for the delivery person.</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 text-center space-x-4">
                        <a href="{{ route('customer.product') }}"
                            class="inline-flex items-center px-6 py-3 bg-gray-800 border border-transparent rounded-md font-semibold text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                            Continue Shopping
                        </a>
                        <a href="{{ route('customer.mongodbReviews.create', ['order' => $order->id]) }}"
                            class="inline-flex items-center px-6 py-3 bg-gray-600 border border-transparent rounded-md font-semibold text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                            Review Our Platform
                        </a>
                    </div>
                </div>
