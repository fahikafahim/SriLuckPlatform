...
.checkout-btn:hover {
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-lg shadow-md p-6 sticky top-6">
                          ...
                          <button id="checkoutBtn" onclick="window.location.href='{{ route('customer.orders.create') }}'"
    ...
    Proceed to Checkout <i class="fas fa-arrow-right ml-2"></i>
                ...
                <div id="emptyCart" class="empty-cart hidden flex flex-col items-center justify-center py-16 rounded-lg">
                    ...
                    <a href="/" class="bg-gray-800 hover:bg-gray-900 text-white py-2 px-6 rounded-md transition-colors duration-200">
                        Start Shopping
                    </a>
                </div>
            </div>
    ...
    function updateCartCount() {
        ...
        // Make sure to include the updateCartCount function from the previous code
// Handle checkout button
    document.getElementById('checkoutBtn').addEventListener('click', function() {
        const userId = document.querySelector('meta[name="user-id"]').content;
        if (!userId) {
        ...
        form.method = 'POST';
        form.action = '/checkout/prepare'; // We'll create this route
